...
import com.dropo.provider.models.datamodels.WalletRequest;
...
public class WithdrawalRequestResponse {
    ...
    public String toString() {
        return "WithdrawalRequestResponse{" + "success = '" + success + '\'' + ",message = '" + message + '\'' + ",wallet_request = '" + walletRequest + '\'' + "}";
    }
