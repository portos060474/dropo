...
public class WalletHistoryAdapter extends RecyclerView.Adapter<WalletHistoryAdapter.WalletHistoryHolder> {
    ...
    public void onBindViewHolder(@NonNull WalletHistoryHolder holder, int position) {
        ...
        try {
            ...
            holder.tvWithdrawalId.setText(String.format("%s %s", walletHistoryFragment.getResources().getString(R.string.text_id), walletHistory.getUniqueId()));
    ...
    protected static class WalletHistoryHolder extends RecyclerView.ViewHolder {
        ...
        CustomFontTextView tvTransactionDate, tvTransactionTime;
        CustomFontTextViewTitle tvWithdrawalId;
        CustomFontTextView tvTransactionState;
