...
import com.dropo.provider.WalletDetailActivity;
import com.dropo.provider.WalletTransactionActivity;
import com.dropo.provider.adapter.WalletHistoryAdapter;
    ...
    private void getWalletHistory() {
        ...
        call.enqueue(new Callback<WalletHistoryResponse>() {
            ...
            public void onResponse(@NonNull Call<WalletHistoryResponse> call, @NonNull Response<WalletHistoryResponse> response) {
                ...
                ivEmpty.setVisibility(walletHistory.isEmpty() ? View.VISIBLE : View.GONE);
            }
