...
public class BankDetailAdapter extends RecyclerView.Adapter<BankDetailAdapter.BankItemView> {
    ...
    protected class BankItemView extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private final CustomFontTextView tvBankAccountNumber;
        private final CustomFontTextView tvAccountHolderName;
        private final CustomFontTextView tvRoutingNumber;
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.ivDeleteBankDetail) {
                bankDetailActivity.openVerifyAccountDialog(bankDetails.get(getAbsoluteAdapterPosition()));
            } else {
                bankDetailActivity.selectBankDetail(bankDetails.get(getAbsoluteAdapterPosition()));
            }
        }
    }
}