...
public class Countries {
    ...
    @SerializedName("is_referral_provider")
    @Expose
    private boolean isReferralProvider;
    ...
    public boolean isReferralProvider() {
        return isReferralProvider;
    }

    public void setReferralProvider(boolean referralProvider) {
        isReferralProvider = referralProvider;
    }
}