...
public class DocumentAdapter extends RecyclerView.Adapter<DocumentAdapter.DocumentViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DocumentViewHolder holder, int position) {
        ...
        GlideApp.with(context).load(IMAGE_URL + documents.getImageUrl()).dontAnimate().placeholder(ResourcesCompat.getDrawable(context.getResources(), R.drawable.uploading, null)).fallback(ResourcesCompat.getDrawable(context.getResources(), R.drawable.uploading, null)).into(holder.ivDocumentImage);
    }
