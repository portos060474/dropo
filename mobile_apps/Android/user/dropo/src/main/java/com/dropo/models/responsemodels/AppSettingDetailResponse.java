...
public class AppSettingDetailResponse {
    ...
    @SerializedName("is_allow_bring_change_option")
    ...
    @SerializedName("max_courier_stop_limit")
    ...
    public boolean isAllowBringChangeOption() {
        return isAllowBringChangeOption;
    }

    public void setAllowBringChangeOption(boolean allowBringChangeOption) {
        isAllowBringChangeOption = allowBringChangeOption;
    }
    ...
    public int getMaxCourierStopLimit() {
        return maxCourierStopLimit;
    }

    public void setMaxCourierStopLimit(int maxCourierStopLimit) {
        this.maxCourierStopLimit = maxCourierStopLimit;
    }
}