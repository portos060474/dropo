...
public class CropImageView extends ImageViewTouchBase {
    ...
    private ImageSizeChangeListener imageSizeChangeListener;
    ...
    public void setImageSizeChangeListener(ImageSizeChangeListener imageSizeChangeListener) {
        this.imageSizeChangeListener = imageSizeChangeListener;
    }
    ...
    public boolean onTouchEvent(@NonNull MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (motionHighlightView != null && event.getPointerId(event.getActionIndex()) ==
                        validPointerId) {
                ...
                // If we're not zoomed then there's no point in even allowing the user to move
                // the image around.
                // This call to center puts it back to the normalized location.
                if (getScale() == 1F) {
                    center();
                }
                imageSizeChangeListener.onSizeChange();
                break;
        }
