...
import com.dropo.store.adapter.StoreTimeAdapter;
...
public class StoreTimeActivity extends BaseActivity {
    public static final String TAG = StoreTimeActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tvToolbarTitle)).setText(getString(R.string.text_store_time));
    ...
    private void openTimePickerDialog() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(this, (timePicker, selectedHour, selectedMinute) -> {
            ...
            if (isValidOpeningTime(dayTime)) {
                ...
                Utilities.showToast(StoreTimeActivity.this, getString(R.string.text_not_valid_Time));
            }
        }, hour, minute, true);
    ...
    public void loadStoreDayData() {
        ...
        if (storeTimeAdapter == null) {
            storeTimeAdapter = new StoreTimeAdapter(dayTimeList, this);
    ...
    private void updateStoreTime(String pass, String socialId) {
        ...
        updateStoreTime.setStoreTime(storeTimeFinalList);
            ...
            public void onResponse(@NonNull Call<IsSuccessResponse> call, @NonNull Response<IsSuccessResponse> response) {
                ...
                if (parseContent.isSuccessful(response)) {
                    if (response.body().isSuccess()) {
                        ParseContent.getInstance().showMessage(StoreTimeActivity.this, response.body().getStatusPhrase());
                        setResult(Activity.RESULT_OK);
                        finish();
                    } else {
                        ParseContent.getInstance().showErrorMessage(StoreTimeActivity.this, response.body().getErrorCode(), response.body().getStatusPhrase());
                    }
                }
            }
