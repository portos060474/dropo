...
public class MultiLineLayout extends ViewGroup {
    ...
    public MultiLineLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MultiLineLayout);
        try {
            mHorizontalSpacing = a.getDimensionPixelSize(R.styleable.MultiLineLayout_horizontalSpacing, 0);
            mVerticalSpacing = a.getDimensionPixelSize(R.styleable.MultiLineLayout_verticalSpacing, 0);
        } finally {
            a.recycle();
        }
