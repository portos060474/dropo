...
import com.dropo.store.StoreTimeActivity;
...
public class StoreTimeAdapter extends RecyclerView.Adapter<StoreTimeAdapter.ViewHolder> implements View.OnClickListener {

    private final StoreTimeActivity storeTimeActivity;
    private ArrayList<DayTime> storeTimeList;

    public StoreTimeAdapter(ArrayList<DayTime> storeOpenTimeList, StoreTimeActivity storeTimeActivity) {
