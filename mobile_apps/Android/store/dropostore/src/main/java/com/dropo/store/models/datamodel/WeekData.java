...
public class WeekData {
    ...
    private ArrayList<Date> particularDate;
    private ArrayList<WeekData> integersWeek;
    ...
    public ArrayList<Date> getParticularDate() {
        return particularDate;
    }

    public void setParticularDate(ArrayList<Date> particularDate) {
        this.particularDate = particularDate;
    }

    public ArrayList<WeekData> getIntegersWeek() {
        return integersWeek;
    }

    public void setIntegersWeek(ArrayList<WeekData> weekDatas) {
        this.integersWeek = weekDatas;
    }
