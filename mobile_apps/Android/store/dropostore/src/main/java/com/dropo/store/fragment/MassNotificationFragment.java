...
import com.dropo.store.adapter.NotificationAdapter;
...
public class MassNotificationFragment extends Fragment {
    ...
    private void getNotification() {
        NotificationRepository.getInstance(activity).getNotification(Notification.MASS_TYPE, new NotificationLoadCallBack() {
            @Override
