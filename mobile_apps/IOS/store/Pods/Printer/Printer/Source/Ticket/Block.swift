...
public struct Block: Printable {
    ...
    public static var defaultFeedPoints: UInt8 = 35
...
public extension Block {
    ...
    // key    value
    static func kvWithAttr(k: String, v: String,predefined attributes: Text.PredefinedAttribute...) -> Block {
    ...
    static func kvWithSpaceCalculator(k: String, v: String) -> Block {
        return Block(Text.kv(k: k, v: v))
    }
