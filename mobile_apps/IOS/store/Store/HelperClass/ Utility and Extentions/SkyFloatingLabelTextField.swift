...
open class SkyFloatingLabelTextField: UITextField {
    ...
    func setTextFieldPropertyDark(placeholder:String) {
        self.placeholder = placeholder
        
        self.textColor = UIColor.black
        self.lineColor = UIColor.lightGray

        self.selectedTitleColor = UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 0.51)
        self.placeholderColor = UIColor(red: 0/255, green: 0/255, blue: 0/255, alpha: 0.51)
        self.selectedLineColor = UIColor.black
        self.placeholderFont = FontHelper.textRegular()
        self.lineHeight = 0.5 // bottom line height in points
        self.selectedLineHeight = 1.5
    }
    func setTextFieldPropertyWhite(placeholder:String) {
        self.placeholder = placeholder
