//
//	ProductGroupRootClass.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class ProductGroupModel : NSObject, NSCoding{

	var message : Int!
	var productGroups : [ProductGroupItem]!
	var success : Bool!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let productGroupsArray = dictionary["product_groups"] as? [[String:Any]]{
			for dic in productGroupsArray{
				let value = ProductGroupItem(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         productGroups = aDecoder.decodeObject(forKey :"product_groups") as? [ProductGroupItem]
