...
//  edelivery
//
//  Created by Elluminati on 08/03/17.
...
open class MyAnimation
{
    ...
    open static let TransformScale =
        {
    ...
    open class func animateCell(_ cell: UICollectionViewCell, withTransform transform: (CALayer) -> CATransform3D, andDuration duration: TimeInterval) {
