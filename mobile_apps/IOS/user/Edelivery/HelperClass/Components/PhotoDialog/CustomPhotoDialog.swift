...
public class CustomPhotoDialog: CustomDialog,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    public static func showPhotoDialog(_ withTitle:String, andParent:UIViewController, leftTitle:String = "", rightTitle:String = "", isCameraOnly:Bool=false, isFrom:Bool = true, isCrop: Bool = false) -> CustomPhotoDialog {
        ...
        if isCameraOnly {
            ...
            view.btnLeft.setTitle("   " + "TXT_GALLERY".localized, for: UIControl.State.normal)
            view.btnRight.setTitle("   " + "TXT_CAMERA".localized, for: UIControl.State.normal)
            view.btnLeft.setImage(UIImage.init(named: "gallery")?.imageWithColor(color: .themeImageColor), for: .normal)
            view.btnRight.setImage(UIImage.init(named: "camera")?.imageWithColor(color: .themeImageColor), for: .normal)
    ...
    func setLocalization() {
        ...
        btnLeft.tintColor = .themeImageColor
        btnRight.tintColor = .themeImageColor
    ...
    func alertPromptToAllowCameraAccessViaSetting() {
        let msg = "MSG_REASON_FOR_CAMERA_PERMISSION".localized.replacingOccurrences(of: "****", with: "APP_NAME".localized)
        let dialogForPermission = CustomAlertDialog.showCustomAlertDialog(title: "IMPORTANT".localized, message: msg, titleLeftButton: "".localizedCapitalized, titleRightButton: "TXT_OK".localizedCapitalized)
