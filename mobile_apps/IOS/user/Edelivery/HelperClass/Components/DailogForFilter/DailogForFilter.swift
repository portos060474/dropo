...
class DailogForFilter: CustomDialog,UITextFieldDelegate  {
    ...
    func setupLocalization() {
        ...
        btnCancel.setTitleColor(UIColor.themeImageColor, for: .normal)
        btnCancel.tintColor = UIColor.themeImageColor
        ...
        ImageForFrom.image = UIImage.init(named: "calendar_gray")?.imageWithColor(color: .themeImageColor)
        ImageForTo.image = UIImage.init(named: "calendar_gray")?.imageWithColor(color: .themeImageColor)
    }
