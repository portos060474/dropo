...
open class MyBadgeButton: UIButton {
    ...
    fileprivate var innerHorizontalMargin : CGFloat = 5.0{
    ...
    /**
     ...
     4 = Center
     **/
    fileprivate var anchorIndex : Int = 1{
        didSet{
            ...
            case 4:
                ...
                break
            default:
                printE("Unknow anchor position. Fallback to default")
                self.anchorIndex = 1
            }
        }
    }
    ...
    fileprivate func setupBadgeViewWithString(badgeText: String?){
        ...
        badgeLabel.font = FontHelper.cartText()
        ...
        var x : CGFloat = (self.frame.width/2), y : CGFloat = 0
