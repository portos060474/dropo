...
//MARK: View life cycle
    ...
    func setLocalization() {
        ...
        lblEmptyMsg.text = "TXT_WALLET_TRANSACTION_HISTORY_LIST_EMPTY".localized
    ...
    func openCancelRequestDialog() {
        ...
        let dialogForCancelRequest = CustomAlertDialog.showCustomAlertDialog(title: "TXT_CANCEL_REQUEST".localized, message: "MSG_ARE_YOU_SURE".localized, titleLeftButton: "TXT_CANCEL".localizedUppercase, titleRightButton: "TXT_OK".localizedUppercase)
        dialogForCancelRequest.onClickLeftButton = { [unowned dialogForCancelRequest] in
...
//MARK:WebService Calls
    func wsCancelWalletRequest() {
        ...
        let dictParam:[String:Any] =
            [PARAMS.WALLET_STATUS : selectedWalletRequest!.walletStatus ?? 0,
