   ...
   //MARK:- OUTLETS
    ...
    public static func  showCustomCardDialog
        (title:String,
         ...
         titleRightButton:String) -> CustomCardDialog {
...
extension CustomCardDialog: STPAuthenticationContext {
    ...
    func wsGetStripeIntent() {
        ...
        alamoFire.getResponseFromURL(url: WebService.GET_STRIPE_ADD_CARD_INTENT, methodName: AlamofireHelper.POST_METHOD, paramData: dictParam) { (response, error) -> (Void) in
